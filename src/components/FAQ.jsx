...
const FAQ = () => {
  ...
  return (
    <section className="w-full bg-[#0F0F11] text-white py-20 px-6 md:px-24">
      <div className="max-w-7xl mx-auto grid grid-cols-1 md:grid-cols-2 gap-12">
        ...
        <div>
          ...
          <button className="px-5 py-2 rounded-lg bg-white text-black flex items-center gap-2 w-fit">
            Contact us
          </button>
        </div>
        ...
        <div className="space-y-3">
          {faqs.map((faq, index) => (
            <div
              key={index}
              className="bg-[#1A1A1D] rounded-xl p-5 cursor-pointer border border-white/5 hover:bg-[#232326] transition-all"
