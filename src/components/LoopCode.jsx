          ...
          <>
            {isVertical ? (
              ...
              <>
                ...
                aria-hidden
                className={cx(
                    'pointer-events-none absolute left-0 top-1/2 -translate-y-1/2 z-10',
                    'h-[40px] w-[clamp(24px,8%,120px)]',
                ...
                aria-hidden
                className={cx(
                    'pointer-events-none absolute right-0 top-1/2 -translate-y-1/2 z-10',
                    'h-[40px] w-[clamp(24px,8%,120px)]',
