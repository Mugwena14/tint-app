            ...
            <div className="max-w-7xl mx-auto px-6 grid md:grid-cols-2 gap-12 items-center">
                ...
                >
                    ...
                    <div className="space-y-4 -mt-10">
                        ...
                        <h1 className="text-4xl font-semibold leading-[1.1] text-gray-900">
                        ...
                        {/* SEAL OF APPROVAL */}
                        <p className="text-[13px] font-medium text-blue-600 tracking-wide">
                    ...
                    <button className="group relative inline-flex items-center gap-2 overflow-hidden w-fit">
                        <span className="absolute inset-0 bg-blue-600 scale-x-0 origin-left transition-transform duration-300 group-hover:scale-x-100">
                        </span> 
                        <span className="relative z-10 px-4 py-3 bg-blue-600 text-white transition-colors duration-300 
                        group-hover:bg-transparent">
                            Explore 
                        </span> 
                        <span className="relative -ml-4 z-10 text-blue-600 group-hover:text-white transition-colors duration-300"> <span className="text-white"
                        >S
                        </span>ervices 
                        </span> <ArrowRight size={18} className="relative z-10 text-blue-600 group-hover:text-white transition-colors duration-300" /> 
                    </button>
                ...
                >
                    {/* BLUE MINIMAL ACCENT BOX */}
                    <div className="absolute top-[-1rem] bottom-[-3rem] right-6 w-[70%] bg-blue-600/90 rounded-md shadow-lg"></div>
