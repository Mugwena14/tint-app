...
const HeroSection = () => {
  return (
    <section
      className="w-full pt-32 pb-8 overflow-hidden relative"
      style={{
    ...
    >
      ...
      <div className="absolute inset-0 pointer-events-none">
        ...
        {/* gradient blur from 80% → right */}
        <div
          className="absolute inset-y-0 right-0 w-2/5"
          style={{
            // this gradient overlay helps the blur to transition smoothly
        ...
        >
          <div className="space-y-4 -mt-10">
            <h1 className="text-4xl font-semibold leading-[1.1] text-white">
              ...
              <br />
              <span className="text-gray-200">Precision. Privacy. Comfort.</span>
            </h1>
            <p className="text-[13px] font-medium text-blue-400 tracking-wide">
          ...
          <button className="group relative inline-flex items-center gap-2 overflow-hidden w-fit">
            ...
            <span className="relative -ml-4 z-10 text-blue-400 group-hover:text-white transition-colors duration-300">
              Services
            </span>
            <ArrowRight
              size={18}
          ...
          <div className="flex items-center gap-4 text-blue-400 pt-2">
