...
const ServiceModal = ({ open, onClose, title, description, benefits }) => {
  ...
  return (
    <div className="fixed inset-0 bg-black/40 backdrop-blur-sm flex items-center justify-center z-50 px-4">
      <div className="bg-white max-w-2xl w-full p-8 rounded-xl shadow-lg relative text-center border-t-4 border-[#c9a24d]">
        ...
        <button
          onClick={onClose}
          className="mt-8 px-6 py-2 rounded-md bg-[#c9a24d] text-white font-medium hover:bg-[#b08b3f] transition"
        >
          Close
        </button>
      </div>
